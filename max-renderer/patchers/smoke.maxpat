...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 420.0, 330.0, 138.0, 33.0 ],
					"text" : "mc.rampsmooth~ 10000 10000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 420.0, 297.0, 58.0, 21.0 ],
					"text" : "mc.!=~ 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 390.0, 375.0, 39.0, 21.0 ],
					"text" : "mc.*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 390.0, 135.0, 64.0, 21.0 ],
					"text" : "mc.dup~ 6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 62.5, 435.0, 58.0, 21.0 ],
					"text" : "mc./~ 2."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 62.5, 405.0, 58.0, 21.0 ],
					"text" : "mc.+~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 62.5, 375.0, 119.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 62.5, 195.0, 187.0, 21.0 ],
					"text" : "mc.list~ 0 0 0 0 0 0 @chans 6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 62.5, 525.0, 132.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 62.5, 555.0, 156.0, 21.0 ],
					"text" : "mc.s~ AUDIO_OUT @chans 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 390.0, 90.0, 76.0, 21.0 ],
					"text" : "r~ AUDIO_IN"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 62.5, 135.0, 101.0, 21.0 ],
					"text" : "o.route /values"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 62.5, 90.0, 33.0, 21.0 ],
					"text" : "r IN"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 60.0, 44.0, 261.0, 19.0 ],
					"text" : "- processing drawing of something nice..."
				}
